...
Comando:!dono
Função: Mostra as informações do criador da Craudia

Comando:!vida
Função mostra a vida (bateria) da Craudia
...
Comandos: !listadmins
Função: marcar ou mostrar todos os ademiros do grupo
Como Usar: basta enviar o comando
